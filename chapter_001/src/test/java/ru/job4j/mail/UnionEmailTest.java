...
public class UnionEmailTest {
    ...
    public void testUnion() {
        ...
        users.put("user2", new HashSet<>(Set.of(
                "foo@gmail.com", "ups@pisem.net")));
        users.put("user3", new HashSet<>(Set.of(
                "xyz@pisem.net", "vasya@pupkin.com")));
        users.put("user4", new HashSet<>(Set.of(
                "ups@pisem.net", "aaa@bbb.ru")));
        users.put("user5", new HashSet<>(Set.of(
                "xyz@pisem.net")));
        users.put("user6", new HashSet<>(Set.of(
                "vasya@pupkin.com", "aaa@bbb.ru", "ups@pisem")));
        users.put("user7", new HashSet<>(Set.of(
                "vasya@pupkin.com", "aaa@bbb.ru", "ups@pisem")));
        users.put("user8", new HashSet<>(Set.of(
                "vasya@pupkin.com")));
    ...
    public void testIdentUnion() {
        Map<String, Set<String>> users = new HashMap<>();
        users.put("user1", new HashSet<>(Set.of(
